                ...
                <table border="0" width="100%">
                    <tr>
                        ...
                        <td style="background-color: transparent;">
                            ...
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <input name="hov_exp_fleets" type="submit" value="H" onclick="document.querySelector('input[name=ship203]').value = 35; document.querySelector('input[name=ship206]').value = 1; document.querySelector('input[name=ship207]').value = 1; document.querySelector('input[name=ship210]').value = 548; document.querySelector('input[name=ship211]').value = 1; document.querySelector('input[name=ship215]').value = 1;">
                        </td>
