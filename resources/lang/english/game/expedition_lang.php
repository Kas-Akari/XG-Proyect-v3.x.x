...
$lang = [
    ...
    'exp_dm_6' => 'A tiny alien creature devoured the captain´s pet elephant. It was a great loss, but they discovered that its digestive system transforms nutrients into dark matter<br><br>Dark Matter %s have been captured.', // ok
    ...
    'exp_nothing_17' => 'The crew found a promising planet, but the captain lost the keys to the ship´s hatch, so they had to turn back empty-handed.<br>A locksmith will be waiting for them at the landing port',
    'exp_nothing_18' => 'After a long and perilous journey, the fleet found an alien probe adrift. After inspecting it, they discovered an object preserved inside with an enigmatic message inscribed on it:<br><br>“I made it to the end of the universe and all I got was this stupid T-shirt”.',
    'exp_nothing_19' => 'The fleet found a damaged merchant ship adrift, with no sign of the crew but a cargo hold full to the brim. They turned out to be boxes and boxes of mouthwash.<br>The crew returns empty-handed but with fresh breath.',
    'exp_nothing_20' => 'The thought that that nebula will one day condense and give birth to a new star fills the crew with determination.<br><br>But beyond that, they return empty-handed.',
